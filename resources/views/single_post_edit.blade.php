                            ...
                            @foreach ($comments as $comment)
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="btn-group">
                                                <a href="/single/{{request()->post_id}}/{{$comment->id}}/edit" class="btn btn-sm btn-outline-secondary">Edit</a>
                                ...
                                <div class="d-flex flex-start w-100">
                                    ...
                                    <div class="form-outline w-100">
                                        <textarea class="form-control @error('comment') is-invalid @enderror" name="comment" rows="4"
                                            style="background: #fff;" value="{{old('comment')}}">{{$comment_to_edit->comment}}</textarea>
                                            @error('comment')
                                            <span class="invalid-feedback" role="alert"> <strong>{{ $message }}</strong></span>
                                            @enderror
                                       <input type="hidden" value="{{request()->post_id}}" name="postid"/>
                                       <input type="hidden" value="{{$comment_to_edit->id}}" name="commentid"/>
                                    </div>
